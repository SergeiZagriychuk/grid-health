...
public class Constants {
    public final static String BUSY_PROXIES = "busy_proxies";
    public final static String FREE_PROXIES = "free_proxies";
    ...
    public final static String STATUS_NOT_SUPPORTED_VERSION = "not supported version";
